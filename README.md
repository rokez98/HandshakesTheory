...
Цепочки отображаются по умолчанию в сжатом виде: только аватарки профилей, составлющих цепь. Пользователь может раскрыть каждую цепочку - при этом выводятся имя и фамилия, а также увеличенная аватарка профиля.

![alt text](https://github.com/rokez98/HandshakesTheory/blob/master/Graphics/SearchResultAndBanner.png?raw=true)
